...
class Primitive {
 public:
  enum Type { Line, Polygon, Circle, Rect, Ellipse, Curve };
  Primitive();
  ...
  static QVector<QPoint> fillRect(QVector<QPoint> args);     // 填充矩形
  static QVector<QPoint> fillPolygon(QVector<QPoint> args);  // 填充多边形
